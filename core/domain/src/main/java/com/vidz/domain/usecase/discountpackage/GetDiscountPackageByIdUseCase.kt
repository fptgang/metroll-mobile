...
class GetDiscountPackageByIdUseCase @Inject constructor(
    private val discountPackageRepository: DiscountPackageRepository
) {
    operator fun invoke(id: String): Flow<Result<DiscountPackage>> {
        return discountPackageRepository.getDiscountPackageById(id)
    }
} 